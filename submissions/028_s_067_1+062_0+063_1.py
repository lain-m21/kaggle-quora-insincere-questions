...
def main(logger, args):
    ...
    # ***** model 1 - 067_1 ***** #
    logger.info(f'Start train and prediction 1 / 3')
    ...
    # ***** model 2 - 063_1 ***** #
    logger.info(f'Start train and prediction 2 / 3')
    ...
    # ***** model 3 - 062_0 ***** #
    logger.info(f'Start train and prediction 3 / 3')
