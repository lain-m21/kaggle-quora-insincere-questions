...
from utils.loader import SimpleDataset, BinaryBalancedSampler
...
def main(logger, args):
    ...
    for fold, (index_train, index_valid) in enumerate(skf.split(label_train, label_train)):
        ...
        sampler = BinaryBalancedSampler(y_train, pos_ratio=0.25, num_samples=len(y_train), shuffle=True)
        ...
        model = StackedRNNFM(embedding_matrix, PADDING_LENGTH, hidden_size=64, out_hidden_dim=32,
