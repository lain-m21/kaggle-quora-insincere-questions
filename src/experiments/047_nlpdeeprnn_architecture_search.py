...
def main(logger, args):
    ...
    model_specs = [
        ...
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'rnn_layer_types': ({'type': 'lstm', 'dim': 64, 'num_layers': 2, 'dropout': 0.2},
                             ),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
        ...
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'rnn_layer_types': ({'type': 'lstm', 'dim': 32, 'num_layers': 2, 'dropout': 0.2},
                             {'type': 'gru', 'dim': 32, 'num_layers': 1, 'dropout': 0.0}),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
        ...
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'rnn_layer_types': ({'type': 'lstm', 'dim': 16, 'num_layers': 1, 'dropout': 0.0},
                             {'type': 'gru', 'dim': 16, 'num_layers': 1, 'dropout': 0.0}),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
        ...
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'rnn_layer_types': ({'type': 'lstm', 'dim': 16, 'num_layers': 2, 'dropout': 0.2},
                             {'type': 'gru', 'dim': 16, 'num_layers': 1, 'dropout': 0.0}),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
