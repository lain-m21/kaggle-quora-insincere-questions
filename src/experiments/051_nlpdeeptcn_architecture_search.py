...
from model.tcn import NLPFeaturesTCN
...
def main(logger, args):
    ...
    model_specs = [
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
         ...
         'tcn_layer_types': ({'num_channels': [64, 64], 'kernel_size': 2, 'dropout': 0.2},
                             {'num_channels': [64, 64], 'kernel_size': 3, 'dropout': 0.2},
                             {'num_channels': [64, 64], 'kernel_size': 4, 'dropout': 0.2}),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [64, 64, 64], 'kernel_size': 2, 'dropout': 0.2},
                             {'num_channels': [64, 64, 64], 'kernel_size': 3, 'dropout': 0.2},
                             {'num_channels': [64, 64, 64], 'kernel_size': 4, 'dropout': 0.2}),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [64, 64, 300], 'kernel_size': 2, 'dropout': 0.2},
                             {'num_channels': [64, 64, 300], 'kernel_size': 3, 'dropout': 0.2},
                             {'num_channels': [64, 64, 300], 'kernel_size': 4, 'dropout': 0.2}),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [32, 32, 32], 'kernel_size': 2, 'dropout': 0.2},
                             {'num_channels': [32, 32, 32], 'kernel_size': 3, 'dropout': 0.2},
                             {'num_channels': [32, 32, 32], 'kernel_size': 4, 'dropout': 0.2}),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [64, 64, 64], 'kernel_size': 3, 'dropout': 0.2},
                             ),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [64, 64, 300], 'kernel_size': 3, 'dropout': 0.2},
                             ),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
    ]
    model_name_base = 'NLPFeaturesTCN'
    ...
    for spec_id, spec in enumerate(model_specs):
        ...
        for fold, (index_train, index_valid) in enumerate(skf.split(label_train, label_train)):
            ...
            model = NLPFeaturesTCN(embedding_matrix, PADDING_LENGTH, nlp_size,
