...
def main(logger, args):
    ...
    model_specs = [
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
         ...
         'tcn_layer_types': ({'num_channels': [128, 128, 300], 'kernel_size': 2, 'dropout': 0.2},
                             {'num_channels': [128, 128, 300], 'kernel_size': 3, 'dropout': 0.2},
                             {'num_channels': [128, 128, 300], 'kernel_size': 4, 'dropout': 0.2}),
        ...
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [128, 128, 128, 300], 'kernel_size': 2, 'dropout': 0.2},
                             {'num_channels': [128, 128, 128, 300], 'kernel_size': 3, 'dropout': 0.2},
                             {'num_channels': [128, 128, 128, 300], 'kernel_size': 4, 'dropout': 0.2}),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [128, 128, 128], 'kernel_size': 2, 'dropout': 0.2},
                             {'num_channels': [128, 128, 128], 'kernel_size': 3, 'dropout': 0.2},
                             {'num_channels': [128, 128, 128], 'kernel_size': 4, 'dropout': 0.2}),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [128, 128, 300], 'kernel_size': 3, 'dropout': 0.2},
                             ),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [128, 128, 128, 300], 'kernel_size': 3, 'dropout': 0.2},
                             ),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.3},
                               )
         },
