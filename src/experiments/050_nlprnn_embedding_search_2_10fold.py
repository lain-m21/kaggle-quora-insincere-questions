...
def main(logger, args):
    ...
    model_specs = [
        {'name': 'glove&paragram+fasttext', 'type': [[0, 2], [1]]},
        {'name': 'glove&fasttext+paragram', 'type': [[0, 1], [2]]},
        {'name': 'fasttext&paragram+glove', 'type': [[0, 2], [1]]},
        {'name': 'glove&fasttext&paragram+fasttext', 'type': [[0, 1, 2], [1]]},
        {'name': 'glove&fasttext&paragram+fasttext+paragram', 'type': [[0, 1, 2], [1, 2]]}
    ]
