...
from model.cnnrnn import StackedBranchedCNNRNN
...
def main(logger, args):
    ...
    model_name = 'StackedRNNFM_CURRENTBEST'
    ...
    for fold, (index_train, index_valid) in enumerate(skf.split(label_train, label_train)):
        ...
        model = StackedBranchedCNNRNN(embedding_matrix, PADDING_LENGTH, hidden_size=32, out_hidden_dim=32,
                                      seq_dropout=0.2, out_drop=0.2, embed_drop=0.1)
