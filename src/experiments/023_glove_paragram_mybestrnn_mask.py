...
from model.baseline_rnn import StackedMaskRNNFM
...
def main(logger, args):
    ...
    for fold, (index_train, index_valid) in enumerate(skf.split(label_train, label_train)):
        ...
        model = StackedMaskRNNFM(embedding_matrix, PADDING_LENGTH, hidden_size=64, out_hidden_dim=64,
