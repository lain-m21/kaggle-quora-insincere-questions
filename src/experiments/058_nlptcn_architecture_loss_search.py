...
def main(logger, args):
    ...
    model_specs = [
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
         ...
         'tcn_layer_types': ({'num_channels': [64, 64], 'kernel_size': 3, 'dropout': 0.2, 'num_layers': 1},),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.5},
                               {'dim': 64, 'dropout': 0.3}),
         'gamma': 2.0, 'alpha': 0.75, 'combined': False, 'focal': False, 'weight': 1.0, 'mask': True},
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [64, 64, 64], 'kernel_size': 3, 'dropout': 0.2, 'num_layers': 1},),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.5},
                               {'dim': 64, 'dropout': 0.3}),
         'gamma': 2.0, 'alpha': 0.75, 'combined': False, 'focal': False, 'weight': 1.0, 'mask': True},
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [64, 64, 600], 'kernel_size': 3, 'dropout': 0.2, 'num_layers': 1},),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.5},
                               {'dim': 64, 'dropout': 0.3}),
         'gamma': 2.0, 'alpha': 0.75, 'combined': False, 'focal': False, 'weight': 1.0, 'mask': True},
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [64, 64, 64, 600], 'kernel_size': 3, 'dropout': 0.2, 'num_layers': 1},),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.5},
                               {'dim': 64, 'dropout': 0.3}),
         'gamma': 2.0, 'alpha': 0.75, 'combined': False, 'focal': False, 'weight': 1.0, 'mask': True},
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
         ...
         'upper_layer_types': ({'dim': 64, 'dropout': 0.5},
                               {'dim': 64, 'dropout': 0.3}),
         'gamma': 2.0, 'alpha': 0.75, 'combined': False, 'focal': False, 'weight': 1.0, 'mask': False},
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [64, 64, 64], 'kernel_size': 3, 'dropout': 0.2, 'num_layers': 1},),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.5},
                               {'dim': 64, 'dropout': 0.3}),
         'gamma': 2.0, 'alpha': 0.75, 'combined': False, 'focal': True, 'weight': 1.0, 'mask': True},
        {'nlp_layer_types': ({'activation': 'relu', 'dim': 16, 'dropout': 0.2},
                             {'activation': 'relu', 'dim': 16, 'dropout': 0.2}),
         'tcn_layer_types': ({'num_channels': [64, 64, 64], 'kernel_size': 3, 'dropout': 0.2, 'num_layers': 1},),
         'upper_layer_types': ({'dim': 64, 'dropout': 0.5},
