...
def main(logger, args):
    ...
    model_specs = [{'nlp_dim': 16, 'nlp_dropout': 0.2, 'num_dense_layers': 2, 'mask': True},
                   {'nlp_dim': 32, 'nlp_dropout': 0.2, 'num_dense_layers': 1, 'mask': True},
                   {'nlp_dim': 16, 'nlp_dropout': 0.2, 'num_dense_layers': 1, 'mask': False},
