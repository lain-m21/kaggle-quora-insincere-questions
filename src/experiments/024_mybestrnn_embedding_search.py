...
def main(logger, args):
    ...
    model_specs = [{'name': 'glove_fasttext', 'embeddings': [0, 1]},
                   {'name': 'glove_paragram', 'embeddings': [0, 2]},
                   {'name': 'fasttext_paragram', 'embeddings': [1, 2]},
                   {'name': 'glove_fasttext_paragram', 'embeddings': [0, 1, 2]}]
    ...
    for spec_id, spec in enumerate(model_specs):
        ...
        embedding_matrix = np.array([embedding_matrices[i] for i in spec['embeddings']]).mean(0)
